...
function DrawerContent({ className, children, fullHeight = false, ...props }: DrawerContentProps) {
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-background fixed z-[1100] flex h-auto min-h-0 flex-col overflow-hidden",
