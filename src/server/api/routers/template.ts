...
function serializeTemplate(template: {
  ...
  return {
    ...
    exercises: template.exercises.map((exercise) => ({
      ...
      sets: exercise.sets,
      unit: exercise.unit === EXERCISE_UNITS.TIME ? EXERCISE_UNITS.TIME : EXERCISE_UNITS.REPS,
      reps: exercise.reps,
...
export const templateRouter = createTRPCRouter({
  getAll: protectedProcedure.input(templateFiltersSchema).query(async ({ input, ctx }) => {
